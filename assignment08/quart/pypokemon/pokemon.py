...
from pypokemon.constants import POKEAPI_SPECIES_URL
from pypokemon.exceptions import PyPokedexError, PyPokedexHTTPError
        ...
        try:
            ...
            for stat in json_data["stats"]:
                ...
                if stat_name in ["hp", "attack", "defense", "speed"]:
                    ...
                    stat_dict["special_attack"] = stat_value
